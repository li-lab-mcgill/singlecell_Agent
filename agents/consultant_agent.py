...
from agents.tools import build_consultant_registry
...
from prompts.consultant_prompts import (
...
class ConsultantAgent:
    ...
    def _build_runner(self, *, system_prompt: str, session_tag: str) -> ToolCallingAgentRunner:
        registry = build_consultant_registry(self.paper_backend, backend=self.single_cell_backend)
    ...
    def generate_plan(self, *, background: str, evaluation_guidance: Dict[str, Any], session_tag: str = "consultant") -> Dict[str, Any]:
        ...
        runner = self._build_runner(system_prompt=self.system_prompt, session_tag=session_tag)
        initial_prompt = (
