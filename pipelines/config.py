...
from pipelines.evaluation_plan import (
...
def _resolve_repo_path(repo_root: str, path_value: str | os.PathLike[str]) -> Path:
...
class Config:
    def __init__(self, code_dir = "saved_code", result_dir = "results", data_dir = "data", file_path = None,
        ...
        code_dir = str(_resolve_repo_path(cur_path, code_dir))
        result_dir = str(_resolve_repo_path(cur_path, result_dir))
        data_dir = str(_resolve_repo_path(cur_path, data_dir))
